...
@section('content')
    <style>
        ...
        .particle:nth-child(2) { left: 30%; animation-delay: 3s; width: 4px; height: 4px; }
        .particle:nth-child(3) { left: 50%; animation-delay: 6s; width: 8px; height: 8px; }
        .particle:nth-child(4) { left: 70%; animation-delay: 9s; }
        .particle:nth-child(5) { left: 85%; animation-delay: 12s; width: 5px; height: 5px; }
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="100">
                    <div class="profile-img-wrapper">
                        <img src="{{ asset('images/banner-light.png') }}" 
                             alt="Shem Profile"
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card project-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A seamless space for connection, event discovery, and collective storytelling for AMOA Youths.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card project-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A social space built for sharing moments instantly, focusing on a clean interface that lets your photos tell the story inspired by Instagram.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card project-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A beautiful and responsive web experience for my long distance boyfriend</p>
                        </div>
                    </div>
                </div>
            </div>
